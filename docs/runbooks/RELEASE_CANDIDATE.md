...
- The committed migration history is contiguous through
  `0034_audit_completion.sql` and the prior production stack is verified
  through `0033_recovery_and_health.sql`.
...
- Production migration history ends at `0034`; schema, grants, RLS, constraints,
